let myvar = document.body.getElementById("send-button");
myvar.addEventListener("click", function(){console.log("hello world")});

//document.getElementById("icon-2xl").addEventListener("click", function(){alert("hello world")});

//document.evaluate(/html/body/div[1]/div/div[1]/div[2]/main/div[1]/div/div[3]/div[1]/div/div/div[2]/form/div[1]/div/div[2]/div/div[2]/div/button).addEventListener("click", function(){alert("hello world")});
